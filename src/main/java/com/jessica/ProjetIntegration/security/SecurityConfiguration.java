package com.jessica.ProjetIntegration.security;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/dashboard").hasAnyRole("ADMIN","UTILISATEUR")
                .antMatchers("/products/create").hasRole("ADMIN")
                .antMatchers("/products/save").hasRole("ADMIN")
                .antMatchers("/products/all").hasAnyRole("ADMIN","UTILISATEUR")
                .antMatchers("/categories/create").hasRole("ADMIN")
                .antMatchers("/categories/save").hasRole("ADMIN")
                .antMatchers("/categories/all").hasAnyRole("ADMIN","UTILISATEUR")
                .antMatchers("/provisionnings/").hasAnyRole("ADMIN","UTILISATEUR")
